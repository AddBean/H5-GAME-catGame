...
var Chapter2 = cc.Layer.extend({
        ...
        initUI: function () {
            this._TextLevel = new TextLayer(this, GC.CHAPTER2_1, GC.CHAPTER2_2);
        ...
        addMainLayer: function () {
            ...
            var poem1 = "";
            var poem2 = "";
            var ele_arr = GC.CHAPTER_LEVEL2.L1;
            switch (this._part_count) {
                case 0:
                    poem1 = GC.POEM7;
                    poem2 = GC.POEM8;
                    this.setGC(GC.CHAPTER_LEVEL2.SCORE1, 8);//设置该关分数，电子数；
                    this.setScore(GC.SCORE1);
                    ele_arr = GC.CHAPTER_LEVEL2.L1.slice(0);
                    break;
                case 1:
                    poem1 = GC.POEM9;
                    poem2 = GC.POEM10;
                    this.setGC(GC.CHAPTER_LEVEL2.SCORE2, 8);//设置该关分数，电子数；
                    this.setScore(GC.SCORE1);
                    ele_arr = GC.CHAPTER_LEVEL2.L2.slice(0);
                    share("我过了第二章第一关，游戏也可以这么文雅", this._msg, 10);
                    break;
                case 2:
                    poem1 = GC.POEM11;
                    poem2 = GC.POEM12;
                    this.setGC(GC.CHAPTER_LEVEL2.SCORE3, 8);//设置该关分数，电子数；
                    this.setScore(GC.SCORE1);
                    ele_arr = GC.CHAPTER_LEVEL2.L3.slice(0);
                    share("我过了第二章第二关，游戏也可以这么文雅", this._msg, 10);
                    break;
                default:
                    //延时切换场景；
                    share("我过了第二章，游戏也可以这么文雅", this._msg, 10);
                    if (this._over_flag) {
                        this._over_flag = false;
                        this.runAction(cc.sequence(cc.delayTime(1), cc.callFunc(function () {
                            cc.log("切换到章节3");
                            var scene = new cc.Scene();
                            scene.addChild(new Chapter3());
        ...
        setGC: function (score, count) {
            ...
            GC.SCORE1=Math.floor(Math.random()*56);
    ...
    ;
Chapter2.scene = function () {
    var scene = new cc.Scene();
    var layer = new Chapter2();
    scene.addChild(layer);
    return scene;
};

var audioEngine = cc.audioEngine;
var playBgMusics2 = function (status) {
    if (status) {
        audioEngine.playMusic(res.bg1_mp3, true);
    } else {
